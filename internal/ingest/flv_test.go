...
func TestParseSPSDimensions(t *testing.T) {
	tests := map[string]struct {
		...
		// Real ffmpeg libx264 testsrc2 vectors (captured from the Annex-B stream).
		"320x240 High profile": {
			sps:    []byte{0x67, 0x64, 0x10, 0x0b, 0xac, 0xb8, 0x28, 0x3f, 0x60, 0x22, 0x00, 0x00, 0x03, 0x00, 0x02, 0x00, 0x00, 0x03, 0x00, 0x04, 0x08},
			width:  320, height: 240,
		},
		"320x240 Baseline profile": {
			sps:    []byte{0x67, 0x42, 0xc0, 0x0b, 0xdc, 0x14, 0x1f, 0xb0, 0x11, 0x00, 0x00, 0x03, 0x00, 0x01, 0x00, 0x00, 0x03, 0x00, 0x02, 0x0f, 0x14, 0x2b, 0x80},
			width:  320, height: 240,
		},
		"1280x720 High profile": {
			sps:    []byte{0x67, 0x64, 0x10, 0x1f, 0xac, 0xb8, 0x0a, 0x00, 0xb7, 0x60, 0x22, 0x00, 0x00, 0x03, 0x00, 0x02, 0x00, 0x00, 0x03, 0x00, 0x04, 0x08},
			width:  1280, height: 720,
		},
		"1920x1080 High profile with cropping": {
			sps:    []byte{0x67, 0x64, 0x10, 0x28, 0xac, 0xb8, 0x0f, 0x00, 0x44, 0xfc, 0xb8, 0x08, 0x80, 0x00, 0x00, 0x03, 0x00, 0x80, 0x00, 0x00, 0x03, 0x01, 0x02},
